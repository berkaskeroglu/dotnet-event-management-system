...
public class DynamicPricingJob : IJob
{
    ...
    public DynamicPricingJob(DatabaseConnectionService dbConnectionService, QueuedDatabaseExecutor executor)
    {
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        await _executor.ExecuteAsync(async () =>
        {
            ...
            using (var connection = _dbConnectionService.GetConnection() as NpgsqlConnection)
            {
